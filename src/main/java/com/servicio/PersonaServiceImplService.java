 ...
 * 
 */
@WebServiceClient(name = "PersonaServiceImplService", targetNamespace = "http://servicio.com/", wsdlLocation = "http://localhost:8080/PersonaServiceImplService/PersonaServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONASERVICEIMPLSERVICE_QNAME = new QName("http://servicio.com/", "PersonaServiceImplService");
    ...
    public IPersonaService getPersonaServiceImplPort() {
        return super.getPort(new QName("http://servicio.com/", "PersonaServiceImplPort"), IPersonaService.class);
    }
     ...
     */
    @WebEndpoint(name = "PersonaServiceImplPort")
    public IPersonaService getPersonaServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicio.com/", "PersonaServiceImplPort"), IPersonaService.class, features);
    }
